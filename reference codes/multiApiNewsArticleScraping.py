...
INPUT_DATASET = "/kaggle/input/nvidia-articles-scrape-bulk/NVDA_2017_2025_LOGGED_BULK.csv"
OUTPUT_FILE  = "/kaggle/working/NVDA_2017_2025_LOGGED_BULK.csv"
...
def fetch_nyt_bulk(start_date, end_date):
    ...
    while page < 100:
        data = safe_request(
            ...
            {
                "q": "Nvidia OR NVDA OR GeForce OR RTX OR \"Jensen Huang\"",
...
def fetch_guardian_for_high_activity_dates(articles_by_date, high_activity_dates):
    ...
    for date_str in high_activity_dates:
        ...
        data = safe_request(
            ...
            {
                "q": "Nvidia OR NVDA OR GeForce OR \"Jensen Huang\"",
                "from-date": date_str,
                "to-date": date_str,
...
def fetch_gnews_for_gaps(articles_by_date, max_calls=100):
    ...
    for date_str in empty_dates_sorted:
        ...
        data = safe_request(
            ...
            {
                "q": "Nvidia OR NVDA OR GeForce OR RTX",
