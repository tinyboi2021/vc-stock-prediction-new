...
input_file_path = "/kaggle/input/apple-final-dataset-merged/merged_financial_news_cleaned_final_merge.csv"
previous_output_path = "/kaggle/input/appl-news-article-dataset/sentiment_scored_article_dataset.csv"
output_file_path = "/kaggle/working/sentiment_scored_article_dataset.csv"
